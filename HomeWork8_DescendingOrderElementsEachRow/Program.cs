...
Console.WriteLine($"\nЗадайте двумерный массив, для этого введите размер массива m x n и диапазон случайных значений:");
int m = InputNumbers("Введите размер строк m: ");
int n = InputNumbers("Введите размер стлдбцов n: ");
int maxValue = InputNumbers("Введите верхнюю границу создаваемого случайного числа: от 1 до ");
